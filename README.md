...
1. What is the DOM?
        ...
        DOM stands for Document Object Model and it is a javascript representation of the HTML. The browser will use this information to build a webpage. 

2. What is an event?

    Every interaction that a user has with a page is called an event. Clicking on a button hightligthing some text, etc.

3. What is an event listener?

        An Event Listentner is placed on elements and track the process of an event, when that event occurs a callback is run. 

4. Why would we convert a NodeList into an Array?

    You would convert a NodeList into an Array in order to get more functionality out of it by making more array methods availible. 

5. What is a component?

    A component in terms of web development is a single modular bit of code that is stand-alone and reusable.  It will typically consist of HTML, CSS and JavaScript. In most cases it is used to keep your code D.R.Y.
